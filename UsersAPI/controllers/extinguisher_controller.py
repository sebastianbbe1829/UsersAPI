...
def actualizar_extintor(extinguisher_id: int, datos: ExtinguisherUpdate, db: Session, user_tenant: UserTenantDB):
...
def exportar_extintores(db: Session, current_user: UserTenantDB, user_tenant: UserTenantDB):
