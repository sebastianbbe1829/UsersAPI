...
from ..domains.cash.models import (
    CashDayBranchDB,
    CashDayDB,
    CashRegisterDB,
...
def get_user_operational_context(db: Session, tenant_id: int, user_tenant_id: int) -> dict:
...
def validate_operational_context(context: dict) -> dict:
