...
from ..domains.clients.services.client_service import list_clients
from ..domains.inventory.services import (
    list_inventory,
    list_products,
    list_top_selling_products,
)
from ..domains.portfolio.services import get_client_credit


def get_pos_catalog(db: Session, tenant_id: int) -> dict:
    return {
