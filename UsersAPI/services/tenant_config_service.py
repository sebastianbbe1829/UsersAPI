...
from ..models import TenantConfigDB, UserTenantDB
...
def _actor(current_user: UserTenantDB) -> str:
...
def read_tenant_config(
    ...
    return get_or_create_tenant_config(
        tenant_id=tenant_id,
...
def update_tenant_config(
    ...
    config = get_or_create_tenant_config(
        tenant_id=tenant_id,
        tenant_name=tenant_name,
        db=db,
        current_user=current_user,
