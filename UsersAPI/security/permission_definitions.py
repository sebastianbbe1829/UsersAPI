...
PERMISSIONS = [
    ...
    ("CONFIG_UI_UPDATE", "Actualizar configuración de UI", "Permite actualizar la configuración de UI"),
    ...
    ("CLIENT_SCREENING", "Consultar compliance de clientes", "Permite consultar el estado de compliance de clientes"),
    (
        "CLIENT_COMPLIANCE_OVERRIDE",
        "Levantar restricción de cliente",
        "Permite levantar una restricción de compliance mediante MFA",
    ),
]
