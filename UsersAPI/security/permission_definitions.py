...
PERMISSIONS = [
    ...
    ("CLIENT_COMPLIANCE_OVERRIDE", "Levantar restricción de cliente", "Permite levantar una restricción de compliance mediante autorización"),
    ...
    ("SALES_AUTOCONSUME", "Autorizar autoconsumo", "Permite registrar ventas a precio de compra sin ganancia"),
    ...
    ("CASH_MOVEMENT_CREATE", "Registrar movimientos de caja", "Permite registrar ingresos y egresos manuales de caja"),
    ("CASH_CLOSE", "Cerrar caja", "Permite realizar el arqueo y cierre de caja"),
    ("CASH_DAY_START", "Iniciar día de caja", "Permite iniciar el día operativo y abrir todas las sucursales y cajas activas"),
    ("CASH_BRANCH_CLOSE", "Cerrar sucursal", "Permite cerrar una sucursal cuando todas sus cajas están cerradas"),
    ("CASH_DAY_CLOSE", "Cerrar día de caja", "Permite cerrar el día cuando todas las sucursales están cerradas"),
]
