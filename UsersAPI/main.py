...
app = FastAPI(
    ...
    openapi_tags=[
        ...
        {"name": "Ventas", "description": "Ventas, clientes participantes, pagos y descuentos por tenant"},
        {"name": "Cartera", "description": "Cupos, obligaciones, saldos y pagos por tenant"},
    ],
)
