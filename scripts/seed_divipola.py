...
def seed_divipola(csv_path: Path = DEFAULT_CSV_PATH) -> None:
    ...
    try:
        ...
        print(f"Departamentos creados: {departamentos_creados}")
        print(f"Departamentos actualizados: {departamentos_actualizados}")
        print(f"Ciudades/unidades creadas: {ciudades_creadas}")
        print(f"Ciudades/unidades actualizadas: {ciudades_actualizadas}")
